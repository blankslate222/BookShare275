<%@ page language="java" contentType="text/html; charset=UTF-8" import="edu.sjsu.cmpe275.bookshare.service.UserService,java.util.List"
    ...
    <html><head>
<title>BOOKSHARE | USER ACCOUNT</title>
...
<ul class="login"><li><a href="${pageContext.request.contextPath}">LOGOUT</a></li> | <li></li><li><a href="${pageContext.request.contextPath}/search">ADVANCE SEARCH</a></li></ul>
	...
	<!---->
	 ...
	 <div class="container"> 
	<h1> Welcome to Account Details.</h1>
	 
	 <h3>(1)<a href="${pageContext.request.contextPath}/updateuser">UPDATE ACCOUNT</a><br></h3>
	 <h3>(2)<a href="${pageContext.request.contextPath}/history/purchase">PURCHASE HISTORY</a><br></h3>
	 <h3>(3)<a href="${pageContext.request.contextPath}/history/sales">SELLING HISTORY</a><br></h3>
	 <h3>(4)<a href="${pageContext.request.contextPath}/myoffers">PENDING OFFERS</a><br></h3>
	 
	<h2> My Books</h2>
	 	<c:choose>
	 		<c:when test = "${ not empty books }">
	 		<c:forEach var = "book" items = "${books}" >
	 		<img src="${pageContext.request.contextPath}/images/wat.gif"/><br>
	 		<a href="${pageContext.request.contextPath}/details/book/id/${book.id}">${book.title}</a><br>
	 		</c:forEach>
	 		</c:when>
	 		<c:otherwise>
